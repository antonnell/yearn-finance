        ...
        <div className={ classes.headerGridContainer }>
          <div className={`${classes.overviewCard} ${classes.overviewDescription}`}>
            <div>
              ...
              <Typography variant='h2' className={ classes.systemTitleDescription }>View all of the protocols and assets involved with the Yearn system or just a specific vault type or vault, even down to an individual strategy.</Typography>
            </div>
          </div>
