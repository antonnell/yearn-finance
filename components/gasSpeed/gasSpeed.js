      ...
      <ToggleButtonGroup
        ...
        <ToggleButton value="slow" >
          <div className={ classes.toggleButtonText }>
             ...
             <Typography className={ classes.smallText }>{ gasPrices.slow } Gwei</Typography>
          </div>
        </ToggleButton>
        <ToggleButton value="standard">
          <div className={ classes.toggleButtonText }>
            <Typography variant='h5'>Standard</Typography>
            <Typography className={ classes.smallText }>{ gasPrices.standard } Gwei</Typography>
         </div>
        </ToggleButton>
        <ToggleButton value="fast">
          <div className={ classes.toggleButtonText }>
            <Typography variant='h5'>Fast</Typography>
            <Typography className={ classes.smallText }>{ gasPrices.fast } Gwei</Typography>
         </div>
        </ToggleButton>
        <ToggleButton value="instant">
          <div className={ classes.toggleButtonText }>
            <Typography variant='h5'>Instant</Typography>
            <Typography className={ classes.smallText }>{ gasPrices.instant } Gwei</Typography>
         </div>
        </ToggleButton>
      </ToggleButtonGroup>
