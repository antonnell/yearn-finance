...
export default function vaultStrategyCard({ strategy, vault }) {
  ...
  const mapStrategyToDescription = (name, tokens) => {
    ...
    if (name.includes("StrategyLenderYieldOptimiser")) {
      ...
      name.includes("StrategyHegicETH") ||
      name.includes("StrategyHegicWBTC")
    ) {
  ...
  return (
    <div className={classes.strategyContainer}>
      <div className={classes.strategyName} onClick={onStrategyClicked}>
        ...
        <Tooltip
          title={mapStrategyToDescription(
            strategy.name,
            vault.tokenMetadata.displayName
          )}
        >
          <Typography className={classes.strategyDescription}>
            {mapStrategyToDescription(
              strategy.name,
              vault.tokenMetadata.displayName
            )}
          </Typography>
