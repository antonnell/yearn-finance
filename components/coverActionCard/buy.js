    ...
    <div className={ classes.buyContainer }>
      ...
      <div className={ classes.textField }>
        <div className={ classes.balances }>
          <Typography variant='h5' onClick={ () => { setAmountPercent(100) } } className={ classes.value } noWrap>Balance: { !coverProtocol.poolData[0].collateralAsset.balance ? <Skeleton /> : formatCurrency(coverProtocol.poolData[0].collateralAsset.balance) }</Typography>
        </div>
        <TextField
          variant="outlined"
          fullWidth
      ...
      { account && account.address &&
        <div className={ classes.actionButton } >
          { (amount==='' || BigNumber(coverProtocol.poolData[0].collateralAsset.allowance).gte(amount)) && (
            <Button
              fullWidth
              disableElevation
              variant='contained'
              ...
              disabled={ loading }
              >
              <Typography variant='h5'>{ loading ? <CircularProgress size={25} /> : 'Buy' }</Typography>
            </Button>
          )}
          { (amount !=='' && (!coverProtocol.poolData[0].collateralAsset.allowance || BigNumber(coverProtocol.poolData[0].collateralAsset.allowance).eq(0) || BigNumber(coverProtocol.poolData[0].collateralAsset.allowance).lt(amount))) && (
            <React.Fragment>
              <Button
                fullWidth
                disableElevation
