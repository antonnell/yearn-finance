...
function LendSupplyAssetDetails({ lendingAsset, account, lendingBorrow, lendingSupply, lendingBorrowLimit }) {
...
export default function LendSupplyAssetRow({ lendingAsset, account, lendingBorrow, lendingSupply, lendingBorrowLimit }) {
  ...
  return (
    <Accordion className={ classes.removePaper } elevation={0} square expanded={ expanded } onChange={ () => { handleExpand() } }>
      ...
      <AccordionDetails>
        <LendSupplyAssetDetails lendingAsset={ lendingAsset } lendingBorrow={ lendingBorrow } lendingSupply={ lendingSupply } lendingBorrowLimit={ lendingBorrowLimit } />
      </AccordionDetails>
    </Accordion>
  )
}
