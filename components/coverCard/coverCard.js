    ...
    >
      <div className={classes.coverTitle}>
        <div className={classes.coverLogo}>
          <img
            src={getLogoForProtocol(cover.name)}
            onError={e => {
      ...
      <div className={classes.coverProtocols}>
        <div className={classes.liquidityInfo}>
          <Typography variant="h5">
            ${" "}
            {formatCurrency(
              cover.poolData[cover.poolData.length - 1].claimPoolData.liquidity
            )}
          </Typography>
        ...
        <div className={classes.liquidityInfo}>
          <Typography variant="h5">
            ${" "}
            {formatCurrency(
              cover.poolData[cover.poolData.length - 1].noClaimPoolData
                .liquidity
            )}
          </Typography>
      ...
      {covered.length > 0 && (
        <div className={classes.coveredInfo}>
          <Typography variant="h5">
            Covered until{" "}
            {moment(cover.expires[cover.expires.length - 1] * 1000).format(
              "YYYY/MM/DD"
            )}
          </Typography>
        </div>
      ...
      {covered.length === 0 && (
        <div className={classes.notCoveredInfo}>
